<template>
  <div class="px-4 py-20 md:py-36 bg-gray1">
    <div class="max-w-5xl mx-auto">
      <h1 class="mb-6 text-black1 text-xl">プライバシーポリシー</h1>
      <p class="text-sm mb-6 text-black1">
        Fast Notion
        運営事務局（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
      </p>
      <h2 class="mb-4 text-black1">第1条（個人情報）</h2>
      <p class="text-sm mb-6 text-black1">
        「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
      </p>
      <h2 class="mb-4 text-black1">第2条（個人情報の収集方法）</h2>
      <p class="text-sm mb-6 text-black1">
        当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
      </p>
      <h2 class="mb-4 text-black1">第3条（個人情報を収集・利用する目的）</h2>
      <p class="text-sm mb-6 text-black1">
      ...
      <h2 class="mb-4 text-black1">第4条（利用目的の変更）</h2>
      <p class="text-sm mb-6 text-black1">
        当社は，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。利用目的の変更を行った場合には，変更後の目的について，当社所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。
      </p>
      <h2 class="mb-4 text-black1">第5条（個人情報の第三者提供）</h2>
      <p class="text-sm mb-6 text-black1">
      ...
      <h2 class="mb-4 text-black1">第6条（個人情報の開示）</h2>
      <p class="text-sm mb-6 text-black1">
      ...
      <h2 class="mb-4 text-black1">第7条（個人情報の訂正および削除）</h2>
      <p class="text-sm mb-6 text-black1">
      ...
      <h2 class="mb-4 text-black1">第8条（個人情報の利用停止等）</h2>
      <p class="text-sm mb-6 text-black1">
      ...
      <h2 class="mb-4 text-black1">第9条（プライバシーポリシーの変更）</h2>
      <p class="text-sm mb-6 text-black1">
        本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。当社が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。
      </p>
      <h2 class="mb-4 text-black1">第10条（お問い合わせ窓口）</h2>
      <p class="text-sm mb-6 text-black1">
        本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。<br />
        <a href="mailto:notionfast@gmail.com" class="underline"
          >notionfast@gmail.com</a
        >
      </p>
    </div>
  </div>
